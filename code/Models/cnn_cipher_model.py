"""
Character CNN Model for Cipher Decryption
Convolutional neural network that processes local patterns in encrypted text
"""
...
class CharCNNDecryptor(nn.Module):
    """
    Character-level CNN for cipher decryption
    ...
    def __init__(self,
                 ...
                 num_conv_layers=3,
                 dropout=0.3):
        super(CharCNNDecryptor, self).__init__()
...
class DeepCharCNNDecryptor(nn.Module):
    """
    ...
    def __init__(self,
                 ...
                 kernel_size=3,
                 dropout=0.3):
        super(DeepCharCNNDecryptor, self).__init__()
        ...
        for i in range(num_layers):
            self.cnn_blocks.append(ResidualCNNBlock(num_filters, kernel_size, dropout))
...
if __name__ == "__main__":
    print("Testing Character CNN Models for Cipher Decryption\n")
    ...
    print("="*60)
    print("1. Multi-Kernel Character CNN")
    print("="*60)
    model1 = CharCNNDecryptor(
    ...
    print(f"Kernel sizes:  [3, 5, 7] (captures different context windows)")
    
    print("\n" + "="*60)
    print("2. Deep Residual Character CNN")
    print("="*60)
    model2 = DeepCharCNNDecryptor(
        vocab_size=vocab_size,
        embedding_dim=128,
        num_filters=256,
        num_layers=6,
    ...
    print("\nArchitecture Notes:")
    print("- Multi-Kernel CNN: Uses 3, 5, 7 character windows simultaneously")
    print("- Deep Residual CNN: Stacks 6 blocks with skip connections for gradient flow")
