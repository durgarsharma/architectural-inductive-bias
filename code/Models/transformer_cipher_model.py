...
Step 2: Character-level Transformer
"""
...
class TransformerDecryptor(nn.Module):
    ...
    def __init__(self,
                 ...
                 dropout=0.1):
        super(TransformerDecryptor, self).__init__()
    ...
    def forward(self, src, tgt):
        ...
        Forward pass
        Args:
            src: [batch_size, src_seq_len] - encrypted text
...
class SimpleTransformerDecryptor(nn.Module):
    """
    Simpler transformer model (encoder-only)
    ...
    def __init__(self,
                 ...
                 dim_feedforward=1024,
                 dropout=0.1):
        super(SimpleTransformerDecryptor, self).__init__()
    ...
    def forward(self, src):
        ...
        Forward pass
        Args:
            src: [batch_size, seq_len] - encrypted text
        Returns:
...
if __name__ == "__main__":
    print("Testing Transformer Models for Cipher Decryption\n")
    ...
    print("\n" + "="*60)
    print("2. Simple Encoder-Only Transformer")
    print("="*60)
    model2 = SimpleTransformerDecryptor(
        vocab_size=vocab_size,
        d_model=256,
        nhead=8,
        num_layers=4,
    ...
    print("\nRecommendation: Start with SimpleTransformerDecryptor")
