"""
Training Script for Transformer - All 6 Ciphers
...
def main(cipher_type='caesar', num_epochs=20, data_dir='data/cipher_datasets_1000',
    ...
    trainer = TransformerTrainer(model, vocab, device=device, learning_rate=learning_rate)
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*60}")
    print(f"Training Transformer on {args.cipher.upper().replace('_', ' ')} cipher")
