"""
Wikipedia Data Downloader - Fixed Version
Step 0, Part 1: Download Wikipedia Articles
"""
...
class WikipediaDownloader:
    """Downloads Wikipedia articles for the cipher project"""
    ...
    def get_popular_articles(self, limit=1000):
        """
        Get list of popular Wikipedia articles using Special:Random
        """
        print(f"Fetching list of {limit} random articles...")
    ...
    def download_article_text(self, title):
        """
        Download the text content of a Wikipedia article
        """
        params = {
            "action": "query",
            "format": "json",
    ...
    def download_corpus(self, num_articles=1000, min_length=500):
        """
        Download a corpus of Wikipedia articles
        """
...
def quick_download(num_articles=50):
    ...
    print("Starting QUICK download (50 articles)...\n")
    downloader = WikipediaDownloader(output_dir="data/wikipedia_sample")
    corpus = downloader.download_corpus(num_articles=num_articles)
    
    if corpus:
        print("✅ Success! Check the 'data/wikipedia_sample' folder.")
    else:
...
def full_download():
    ...
    print("Starting FULL download (1000 articles)...\n")
    ...
    if corpus:
        print("✅ Full corpus downloaded successfully!")
    else:
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("Wikipedia Corpus Downloader for Cipher Research")
    print("="*60 + "\n")
    print("Options:")
