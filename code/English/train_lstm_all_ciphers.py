"""
Training Script for LSTM - All 6 Ciphers
...
class LSTMTrainer:
    """Trainer class for LSTM cipher decryption"""
...
def main(cipher_type='caesar', num_epochs=20, data_dir='data/cipher_datasets_1000',
    ...
    trainer = LSTMTrainer(model, vocab, device=device, learning_rate=learning_rate)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train LSTM for cipher decryption')
    ...
    print(f"\n{'='*60}")
    print(f"Training LSTM on {args.cipher.upper().replace('_', ' ')} cipher")
