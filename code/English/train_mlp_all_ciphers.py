"""
Training Script for MLP - All 6 Ciphers
...
class MLPTrainer:
    """Trainer for MLP cipher decryption"""
...
def main(cipher_type='caesar', num_epochs=20, data_dir='data/cipher_datasets_1000',
    ...
    if train_fraction < 1.0:
        ...
        from models.data_loader import collate_batch
    ...
    trainer = MLPTrainer(model, vocab, device=device, learning_rate=learning_rate)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train MLP for cipher decryption')
    ...
    print(f"\n{'='*60}")
    print(f"Training {model_type} on {args.cipher.upper().replace('_', ' ')} cipher")
