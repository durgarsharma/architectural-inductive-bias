"""
Training Script for LSTM Cipher Decryption
Step 1, Part 1: Complete training pipeline
"""
...
def main(cipher_type='caesar', num_epochs=20):
    ...
    # Create trainer
    trainer = LSTMTrainer(model, vocab, device=device, learning_rate=0.001)
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*60}")
    print(f"Training LSTM on {args.cipher.upper()} cipher")
    print(f"{'='*60}\n")
