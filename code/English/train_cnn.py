"""
Training Script for Character CNN - All 6 Ciphers
...
class CNNTrainer:
    """Trainer for CNN cipher decryption"""
...
def main(cipher_type='caesar', num_epochs=20, data_dir='data/cipher_datasets_1000',
    ...
    trainer = CNNTrainer(model, vocab, device=device, learning_rate=learning_rate)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train Character CNN for cipher decryption')
