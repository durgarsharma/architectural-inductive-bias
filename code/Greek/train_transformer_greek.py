"""
Training Script for Greek Transformer - All 6 Ciphers
Updated for Greek alphabet with early stopping
"""
...
class GreekTransformerTrainer:
    """Trainer for Greek Transformer cipher decryption"""
    
    def __init__(self, model, vocab, device='cp', learning_rate=0.0001):
    ...
    def train(self, train_loader, val_loader, num_epochs=20, save_dir='results', 
        ...
        print("\n" + "="*70)
        print("Starting Greek Transformer Training")
        print("Εκκίνηση Εκπαίδευσης Transformer για Ελληνικά")
        print("="*70)
        ...
        print(f"\n{'='*70}")
        print(f"Training Complete! Ολοκλήρωση Εκπαίδευσης!")
    ...
    def plot_training_history(self, save_path='results/training_history.png', max_epochs=20):
        ...
        ax1.set_title('Greek Transformer: Training and Validation Loss', fontsize=12, fontweight='bold')
        ax1.legend(loc='best')
        ...
        ax2.set_title('Greek Transformer: Validation Accuracy', fontsize=12, fontweight='bold')
        ax2.legend(loc='best')
...
def main(cipher_type='caesar', num_epochs=20, data_dir='data/cipher_datasets_greek_1000',
         train_fraction=1.0, learning_rate=0.0001, d_model=256, 
         patience=5, min_delta=0.001):
    ...
    if train_fraction < 1.0:
        ...
        from models.data_loader_greek import collate_batch
    ...
    print("\nInitializing Greek Transformer model...")
    ...
    print(f"Vocabulary size: {vocab.vocab_size} (Greek alphabet: 24 letters)")
    
    trainer = GreekTransformerTrainer(model, vocab, device=device, learning_rate=learning_rate)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train Greek Transformer for cipher decryption')
    ...
    print(f"\n{'='*70}")
    print(f"Training Greek Transformer on {args.cipher.upper().replace('_', ' ')} cipher")
    ...
    print("\n✅ Greek Transformer training complete!")
