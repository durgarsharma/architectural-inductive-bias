"""
Training Script for Greek Character CNN - All 6 Ciphers
...
class GreekCNNTrainer:
    """Trainer for Greek CNN cipher decryption"""
    ...
    def train(self, train_loader, val_loader, num_epochs=20, save_dir='results',
        ...
        print("\n" + "="*70)
        print("Starting Greek CNN Training")
        print("Εκκίνηση Εκπαίδευσης CNN για Ελληνικά")
        print("="*70)
    ...
    def plot_training_history(self, save_path='results/training_history.png', max_epochs=20):
        ...
        ax1.set_title('Greek CNN: Training and Validation Loss', fontsize=12, fontweight='bold')
        ax1.legend(loc='best')
        ...
        ax2.set_title('Greek CNN: Validation Accuracy', fontsize=12, fontweight='bold')
        ax2.legend(loc='best')
...
def main(cipher_type='caesar', num_epochs=20, data_dir='data/cipher_datasets_greek_1000',
    ...
    if use_deep:
        ...
        model_name = "cnn_greek"
    
    print(f"Model type: {model_name}")
    print(f"Model parameters: {count_parameters(model):,}")
    print(f"Vocabulary size: {vocab.vocab_size} (Greek alphabet: 24 letters)")
    
    trainer = GreekCNNTrainer(model, vocab, device=device, learning_rate=learning_rate)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train Greek Character CNN for cipher decryption')
