"""
Training Script for Greek LSTM - All 6 Ciphers
...
class GreekLSTMTrainer:
    """Trainer class for Greek LSTM cipher decryption"""
    ...
    def train(self, train_loader, val_loader, num_epochs=20, save_dir='results',
        ...
        print("\n" + "="*70)
        print("Starting Greek LSTM Training")
        print("Εκκίνηση Εκπαίδευσης LSTM για Ελληνικά")
        print("="*70)
    ...
    def plot_training_history(self, save_path='results/training_history.png', max_epochs=20):
        ...
        ax1.set_title('Greek LSTM: Training and Validation Loss', fontsize=12, fontweight='bold')
        ax1.legend(loc='best')
        ...
        ax2.set_title('Greek LSTM: Validation Accuracy', fontsize=12, fontweight='bold')
        ax2.legend(loc='best')
...
def main(cipher_type='caesar', num_epochs=20, data_dir='data/cipher_datasets_greek_1000',
    ...
    trainer = GreekLSTMTrainer(model, vocab, device=device, learning_rate=learning_rate)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train Greek LSTM for cipher decryption')
    ...
    print(f"\n{'='*70}")
    print(f"Training Greek LSTM on {args.cipher.upper().replace('_', ' ')} cipher")
