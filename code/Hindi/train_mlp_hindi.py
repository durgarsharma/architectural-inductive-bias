"""
Training Script for MLP - All 6 Ciphers (Hindi/Devanagari)
...
class MLPTrainerHindi:
    """Trainer for MLP cipher decryption (Hindi)"""
    ...
    def train(self, train_loader, val_loader, num_epochs=20, save_dir='results',
        ...
        print("\n" + "="*60)
        print("Starting Hindi MLP Training")
        print("="*60)
...
def main(cipher_type='caesar', num_epochs=20, data_dir='data/cipher_datasets_hindi_1000',
    ...
    if use_context:
        ...
        model_name = "mlp_hindi"
    
    print(f"Model type: {model_name}")
    print(f"Model parameters: {count_parameters(model):,}")
    
    trainer = MLPTrainerHindi(model, vocab, device=device, learning_rate=learning_rate)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train MLP for Hindi cipher decryption')
